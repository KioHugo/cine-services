...
-- Listage des données de la table projet-cine.acteur : ~20 rows (environ)
...
INSERT INTO `film` (`id`, `nom`, `description`, `url`, `id_categorie`) VALUES
	(1, 'La Grande Vadrouille', 'En 1942, un avion anglais est abattu par les Allemands au-dessus de Paris. Les trois pilotes sautent en parachute et atterrissent dans différents endroits de la capitale. Ils sont aidés par deux civils français, un chef d\'orchestre et un peintre en bâtiment qui acceptent de les mener en zone libre; ils deviennent ainsi, malgré eux, acteurs de la Résistance.', 'https://media.senscritique.com/media/000012584893/160/La_Grande_Vadrouille.jpg', 1),
	...
	(4, 'La Soupe aux choux', 'Le Glaude et le Bombé, deux vieux paysans portés sur la bouteille, vivent très retirés de la vie moderne. Une nuit, un extra-terrestre atterrit en soucoupe volante dans le jardin du Glaude. En gage de bienvenue, ce dernier lui offre un peu de sa fameuse soupe aux choux...', 'https://media.senscritique.com/media/000010795955/160/La_Soupe_aux_choux.jpg', 1),
	...
	(6, 'Once Upon a Time... in Hollywood', 'En 1969, la star de télévision Rick Dalton et le cascadeur Cliff Booth, sa doublure de longue date, poursuivent leurs carrières au sein d’une industrie qu’ils ne reconnaissent plus.', 'https://media.senscritique.com/media/000018630904/160/Once_Upon_a_Time_in_Hollywood.jpg', 1),
	(7, 'Toy Story 4', 'Woody a toujours privilégié la joie et le bien-être de ses jeunes propriétaires – Andy puis Bonnie – et de ses compagnons, n’hésitant pas à prendre tous les risques pour eux, aussi inconsidérés soient-ils. L’arrivée de Forky un nouveau jouet qui ne veut pas en être un dans la chambre de Bonnie met toute la petite bande en émoi. C’est le début d’une grande aventure et d’un extraordinaire voyage pour Woody et ses amis. Le cowboy va découvrir à quel point le monde peut être vaste pour un jouet…', 'https://media.senscritique.com/media/000018476713/160/Toy_Story_4.jpg', 1),
	(8, 'Avengers: Endgame', 'Thanos ayant anéanti la moitié de l’univers, les Avengers restants resserrent les rangs dans ce vingt-deuxième film des Studios Marvel, grande conclusion d’un des chapitres de l’Univers Cinématographique Marvel.', 'https://media.senscritique.com/media/000018476719/160/Avengers_Endgame.jpg', 1),
	(9, 'Dragons 3: Le Monde caché', 'Harold est maintenant le chef de Berk au côté d’Astrid et Krokmou, en tant que dragon, est devenu le leader de son espèce. Ils réalisent enfin leurs rêves de vivre en paix entre vikings et dragons. Mais lorsque l’apparition soudaine d’une Furie Eclair coïncide avec la plus grande menace que le village n’ait jamais connue, Harold et Krokmou sont forcés de quitter leur village pour un voyage dans un monde caché dont ils n’auraient jamais soupçonnés l’existence. Alors que leurs véritables destins se révèlent, dragons et vikings vont se battre ensemble jusqu’au bout du monde pour protéger tout ce qu’ils chérissent', 'https://media.senscritique.com/media/000018296169/160/Dragons_3_Le_Monde_cache.jpg', 1),
	...
	(16, 'Dumbo', 'Les enfants de Holt Farrier, ex-artiste de cirque chargé de s’occuper d’un éléphanteau dont les oreilles démesurées sont la risée du public, découvrent que ce dernier sait voler…', 'https://media.senscritique.com/media/000018360675/160/Dumbo.jpg', 1);
...
-- Listage des données de la table projet-cine.film_acteur : ~0 rows (environ)
...
-- Listage des données de la table projet-cine.serie_acteur : ~0 rows (environ)
