...
INSERT INTO `serie` (`id`, `nom`, `description`, `url`, `id_categorie`) VALUES
	...
	(6, 'Riverdale', 'Naviguant dans les eaux troubles du sexe, de l\'amour, de l\'éducation et de la famille, Archie et ses amis se retrouvent plongés au cœur d\'une mystérieuse affaire.', 'https://media.senscritique.com/media/000016645955/160/Riverdale.jpg', 5),
	...
	(12, 'Alerte Cobra', 'Alerte Cobra relate l\'action d\'une unité de police autoroutière allemande : l\'équipe Cobra 11, qui a vu défiler de nombreux duos de policiers qui se recomposent au gré des péripéties.', 'https://media.senscritique.com/media/000006494375/160/Alerte_Cobra.jpg', 4),
